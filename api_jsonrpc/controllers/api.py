...
class RestApi(Controller):
    ...
    @route('/api_json_rpc/auth', auth='none', methods=["POST"])
    @make_response()
    ...
    @route('/api_json_rpc/<string:model>', auth='user', methods=["GET"])
    @make_response()
    def search_read(self, model, **kwargs):
        eval_request_params(kwargs)
        return request.env[model].search_read(**kwargs)

    @route('/api_json_rpc/<string:model>/<int:id>', auth='user', methods=["GET"])
    @make_response()
    ...
    @route('/api_json_rpc/<string:model>', auth='user',
    ...
    @route('/api_json_rpc/<string:model>/<int:id>', auth='user',
    ...
    @route('/api_json_rpc/<string:model>/<int:id>/<string:method>', auth='user',
           methods=["PUT"], csrf=False)
    @make_response()
